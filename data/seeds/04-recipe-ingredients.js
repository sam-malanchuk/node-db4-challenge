...
exports.seed = function(knex) {
  return knex('recipe_ingredients').insert([
    ...
    { recipe_id: 1, ingredients_id: 7, quantity: 1 },
    { recipe_id: 2, ingredients_id: 10, quantity: 5 },
    { recipe_id: 2, ingredients_id: 2, quantity: 1 },
    { recipe_id: 2, ingredients_id: 8, quantity: 1 },
    { recipe_id: 2, ingredients_id: 7, quantity: 1 },
    { recipe_id: 2, ingredients_id: 4, quantity: 1 },
    { recipe_id: 2, ingredients_id: 5, quantity: 1 },
    { recipe_id: 3, ingredients_id: 2, quantity: 1 },
    { recipe_id: 3, ingredients_id: 8, quantity: 1 },
    { recipe_id: 3, ingredients_id: 9, quantity: 1 }
  ]);
};
